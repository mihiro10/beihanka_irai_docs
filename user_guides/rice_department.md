...
<!-- 📸 スクリーンショット: 米飯課ダッシュボード全体 -->
<!-- ![米飯課ダッシュボード](images/rice_dashboard.png) -->
...
<!-- 📸 スクリーンショット: 早朝/昼間ダッシュボード -->
<!-- ![ダッシュボード画面](images/rice_dashboard_view.png) -->
...
<!-- 📸 スクリーンショット: 確定ボタン -->
<!-- ![確定ボタン](images/rice_confirm_button.png) -->
...
<!-- 📸 スクリーンショット: 米飯課予定登録画面 -->
<!-- ![米飯課予定登録](images/rice_schedule_block.png) -->
